...
<div class="container docs-container">
	<div class="row">
		...
		<!-- section start -->
		<div class="col-md-9" role="main">
			<div class="docs-section" align="">
				<div class="page-header">
					<h1 id="docs">组件文档</h1>
					<p class="book-mark">
					<a href="#controller">控制器</a>
					<a href="#database">数据库</a>
					<a href="#template">模板引擎</a>
					<a href="#cache">文件缓存</a>
					<a href="#tool">工具</a>
					<a href="#extra">附录</a></p>
				</div>
				...
				<h3 id="database">操作数据库</h3>
					...
					然后修改配置文件<code>/core/component/db/db.conf.php</code>,按照提示修改 <code>dsn,username,password</code> 等等
					<img alt="fyscu" src="tpl/images/pic_db.png">
					</p>
					<p>
				...
				<h3 id="cache">文件缓存</h3>
					<p>
					文件缓存允许你将<code>输出的页面</code>或<code>一组数据 </code>存储到本地文件上，以提高系统的性能。<br>
					<table class="table table-striped">
					<tr><td><code>CACHE::set($key,$data)</code></td><td>参数：<code>$key</code> 字符串，作为缓存文件的标识,<code>$data</code> 存放到缓存的数据，可以是一段文本或<code>json</code></td></tr>
					<tr><td><code>CACHE::get($key,$cache_time)</code></td><td>参数：<code>$key</code> 字符串，作为缓存文件的标识,<code>$key,$data</code>可选参数，自定义本次的过期判断时间</td></tr>
					</table>
					</p>
					
					以下是一个例子：<br>
					<img alt="fyscu" src="tpl/images/pic004.png" align="">
				...
				<h3>扩展阅读</h3>
					<p>1. windows下WAMP的安装：<a target="_blank" href="http://log.fyscu.com/index.php/archives/80/">http://log.fyscu.com/index.php/archives/80/</a></p>
			</div>
		</div>
		<!-- section end -->
		...
		<div class="col-md-9" role="main">
			<div class="docs-section">
				...
				<p>电子邮箱：<a target="_blank" href="mailto:admin@lanhao.name">admin@lanhao.name</a></p>
				<p>个人主页：<a target="_blank" href="http://www.lanhao.name" target="_blank">http://www.lanhao.name</a></p>
				<p>代码仓库：<a target="_blank" href="http://git.oschina.net/captainblue/" target="_blank">http://git.oschina.net/captainblue/</a></p>
			</div>
		</div>
		<!-- section end -->
		<!-- section start -->
